...
Utils.viper_tools.set_console_title(f"FunPay Viper v{VERSION}")
...
print(f"{Fore.MAGENTA}{Style.BRIGHT}By {Fore.BLUE}{Style.BRIGHT}Woopertail, @beedge{Style.RESET_ALL}")
print(
    f"{Fore.MAGENTA}{Style.BRIGHT} * GitHub: {Fore.BLUE}{Style.BRIGHT}github.com/FunPayViper/FunPayViper{Style.RESET_ALL}")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Telegram: {Fore.BLUE}{Style.BRIGHT}t.me/FunPayViper")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Новости о обновлениях: {Fore.BLUE}{Style.BRIGHT}t.me/fpv_updates")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Плагины: {Fore.BLUE}{Style.BRIGHT}t.me/fpv_plugins")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Донат: {Fore.BLUE}{Style.BRIGHT}t.me/beedge_donate")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Telegram-чат: {Fore.BLUE}{Style.BRIGHT}t.me/funpay_viper")
...
if sys.platform == "linux" and os.getenv('FPV_IS_RUNNIG_AS_SERVICE', '0') == '1':
    ...
    pid = str(os.getpid())
    pidFile = open(f"/run/FunPayViper/{getpass.getuser()}/FunPayViper.pid", "w")
    pidFile.write(pid)
    pidFile.close()
...
try:
    Viper(MAIN_CFG, AD_CFG, AR_CFG, RAW_AR_CFG, VERSION).init().run()
except KeyboardInterrupt:
    logger.info("Завершаю программу...")  # locale
    sys.exit()
except:
    logger.critical("При работе Вайпера произошла необработанная ошибка.")  # locale
    logger.warning("TRACEBACK", exc_info=True)
