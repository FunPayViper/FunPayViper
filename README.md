<h1 align="center">FunPay Viper</h1>
<h4 align="center">Простой и эффективный бот для автоматизации FunPay</h4>

<h2 align="center">Перед началом настоятельно рекомендую залететь в наш <a href="https://t.me/funpay_viper">Telegram
...
- Возможность полностью настраивать автовыдачу / автоответчик и все остальные модули FPV.
...
- Создание плагинов для кастомизации функционала без редактирования исходного кода самого Вайпера.
...
- Собственный Python-пакет FunPayAPI, который никак не привязан к FunPay Viper.
- Поддержка лично от меня :)

## :electric_plug: Плагины

- [Канал с плагинами](https://t.me/fpv_plugins)
...
2. Скачайте [FunPay Viper](https://github.com/FunPayViper/FunPayViper/archive/refs/heads/master.zip)
3. Перенести папку `FunPayViper-main` в нужное Вам место.
4. Перейдите в папку `FunPayViper-main`.
...
1. Выполните команду:
   `wget https://raw.githubusercontent.com/FunPayViper/FunPayViper/main/install-fpv.sh -O install-fpv.sh && bash install-fpv.sh`
...
нашем [Telegram чате](https://t.me/funpay_viper).

## :star: Star it

Если вам удобно пользоваться FunPay Viper, не забудьте поставить :star: звезду :star: данному проекту в правом
