...
access_granted = "🔓 Access granted!\n\n" \
                 ...
                 "⚙️ To open the <i>FunPay Viper</i> settings menu, send me /menu."
...
❌ <i>FunPay Viper</i> is not initialized yet and none of its functions work.\n
🔃 As soon as <i>FunPay Viper</i> is initialized, this message will change.\n
📋 If <i>FPV</i> does not initialize for a long time, check the logs with /logs"""

fpv_init = """✅ <b><u>FunPay Viper initialized!</u></b>\n
ℹ️ <b><i>Version:</i></b> <code>{}</code>
👑 <b><i>Account:</i></b>  <code>{}</code> | <code>{}</code>
💰 <b><i>Balance:</i></b> <code>{}₽, {}$, {}€</code>
📊 <b><i>Active orders:</i></b>  <code>{}</code>

💬 <b><i>Telegram chat:</i></b> @funpay_viper
🔄 <b><i>Updates:</i></b> @fpv_updates
🧩 <b><i>Plugins:</i></b> @fpv_plugins
👨‍💻 <b><i>Developer:</i></b> @beedge
🤑 <b><i>Donate:</i></b> @beedge_donate"""
...
about = """<b>🐍 FunPay Viper 🐍 v{}</b>\n
<i>Telegram chat:</i> @funpay_viper
<i>Updates:</i> @fpv_updates
<i>Plugins:</i> @fpv_plugins
<i>Developer:</i> @beedge
<i>Donate:</i> @beedge_donate"""
...
update_lasted = "✅ You have the latest version FunPayViper {}"
...
pl_new = "Send me a plugin.\n\n<b>⚠️ ATTENTION! Downloading plugins from questionable sources may lead to unfortunate consequences.\n" \
         "@fpv_plugins solves most potential issues.</b>"

au_user_settings = "Settings for user {}"
adv_fpv = "😎 FunPay Viper - the best bot for FunPay"
adv_description = """🐍 FunPay Viper v{}🐍
...
🛠️ Made with: github.com/FunPayViper/FunPayViper
👨‍💻 Author: @beedge
💰 Donate: @beedge_donate
🔄 Updates: @fpv_updates
🧩 Plugins: @fpv_plugins
💬 Chat: @funpay_viper"""
