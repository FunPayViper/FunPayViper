...
access_granted = "🔓 Доступ к ПУ предоставлен!\n\n" \
                 ...
                 "⚙️ Чтобы открыть меню настроек <i>FunPay Viper</i>, введи команду /menu."
...
❌ <i>FunPay Viper</i> еще <b><u>не инициализирован</u></b> и <b><u>никакие его функции не работают</u></b>.\n
🔃 Как только <i>FunPay Viper</i> инициализируется, данное сообщение изменится.\n
📋 Если <i>FPV</i> долго не инициализируется, проверь логи с помощью команды /logs"""

fpv_init = """✅ <b><u>FunPay Viper инициализирован!</u></b>\n
...
🔄 <b><i>Обновления:</i></b> @fpv_updates
🧩 <b><i>Плагины:</i></b> @fpv_plugins
👨‍💻 <b><i>Разработчик:</i></b> @beedge
...
<i>Обновления:</i> @fpv_updates
<i>Плагины:</i> @fpv_plugins
<i>Разработчик:</i> @beedge
...
update_lasted = "✅ У тебя стоит последняя версия FunPayViper {}"
...
pl_new = "Отправь мне плагин.\n\n<b>⚠️ ВНИМАНИЕ! Загрузка плагинов из сомнительных источников может привести к печальным последствиям.\n" \
         "@fpv_plugins решает большинство возможных проблем.</b>"

au_user_settings = "Настройки для пользователя {}"
adv_fpv = "😎 FunPay Viper - лучший бот для FunPay"
...
🛠️ Сделано с помощью: github.com/FunPayViper/FunPayViper
👨‍💻 Автор: @beedge
💰 Донат: @beedge_donate
🔄 Обновления: @fpv_updates
🧩 Плагины: @fpv_plugins
💬 Чат: @funpay_viper"""
